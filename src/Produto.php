...
class Produto {
    ...
    private PDO $conexao; // use linha 4
    ...
    {
        $this->id = filter_var($id, FILTER_SANITIZE_NUMBER_INT); //GET
        return $this;
    }
    ...
    {
        $this->nome = filter_var($nome, FILTER_SANITIZE_SPECIAL_CHARS); //POST
        return $this;
    }
    ...
    {
        $this->descricao = filter_var($descricao, FILTER_SANITIZE_SPECIAL_CHARS); //POST
        return $this;
    }
    ...
    {
        $this->preco = filter_var($preco, FILTER_SANITIZE_NUMBER_FLOAT, FILTER_FLAG_ALLOW_FRACTION); //POST
        return $this;
    }
    ...
    {
        $this->quantidade = filter_var($quantidade, FILTER_SANITIZE_NUMBER_INT ); //POST
        return $this;
    }
    ...
    {
        $this->fabricanteId =filter_var($fabricanteId, FILTER_SANITIZE_NUMBER_INT); //GET
        return $this;
    }
}
